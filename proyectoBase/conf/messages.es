...
playauthenticate.password.verify_signup.subject=ProyectoEscarabajo: Complete su registro
playauthenticate.password.verify_email.subject=ProyectoEscarabajo: Confirme su dirección de email
playauthenticate.password.reset_email.subject=ProyectoEscarabajo: Cómo restablecer su contraseña
...
playauthenticate.login.oauth=Tambien puede entrar usando su cuenta con alguno de los siguientes proveedores:
...
playauthenticate.index.title=Bienvenido Proyecto Escarabajo
